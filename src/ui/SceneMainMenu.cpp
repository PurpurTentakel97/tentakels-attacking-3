...
namespace ui {
    void MainMenu::Initialize() {
        ...
        auto galaxy = std::make_shared<GalaxyScene>(GetElementPosition(0.95f, 0.95f),
        ...
        auto title = std::make_shared<uil::Title>(
                GetElementPosition(0.625f, 0.025f), GetElementSize(0.7f, 0.2f), uil::Alignment::TOP_MID, false);
        m_elements.push_back(title);

        auto versionAndCopyRight = std::make_shared<uil::Text>(GetElementPosition(0.99f, 0.98f),
                                                               GetElementSize(0.1f, 0.1f),
                                                               uil::Alignment::BOTTOM_RIGHT,
                                                               uil::Alignment::BOTTOM_RIGHT,
                                                               0.02f,
                                                               appContext.constants.g_version.get_game_version() + '\n'
                                                                       + appContext.constants.g_global.get_copyright());
        ...
        auto gameBtn = std::make_shared<uil::ExpandingButton>(focusID,
        ...
        auto continueBtn =
                std::make_shared<uil::ClassicButton>(focusID,
                                                     Vector2{ 0.0f, 0.0f },
                                                     Vector2{ 0.0f, 0.0f },
        ...
        gameBtn->Add(continueBtn, appContext.constants.isGameRunning);
        ...
        auto networkBtn = std::make_shared<uil::ClassicButton>(focusID,
                                                               Vector2{ 0.0f, 0.0f },
                                                               Vector2{ 0.0f, 0.0f },
                                                               uil::Alignment::DEFAULT,
        ...
        auto savesBtn = std::make_shared<uil::ExpandingButton>(focusID,
                                                               GetElementPosition(btnPosX, btnPosY),
                                                               GetElementSize(btnSizX, btnSizY),
                                                               uil::Alignment::MID_RIGHT,
                                                               uil::ExpandingButton::RIGHT,
        ...
        saveGameBtn->SetOnClick([]() {
            ...
            if (not appContext_.constants.isGameSaved) {
                appContext_.constants.isGameSaved = true;
                eve::ShowMessagePopUpEvent const event{
                    "debug save", "set save bool to false\nwill be set later when a game was saved.", []() {}
                };
        ...
        auto settingsBtn = std::make_shared<uil::ExpandingButton>(focusID,
                                                                  GetElementPosition(btnPosX, btnPosY),
                                                                  GetElementSize(btnSizX, btnSizY),
                                                                  uil::Alignment::MID_RIGHT,
                                                                  uil::ExpandingButton::RIGHT,
        ...
        auto gameSettingsBtn = std::make_shared<uil::ClassicButton>(focusID,
                                                                    Vector2{ 0.0f, 0.0f },
                                                                    Vector2{ 0.0f, 0.0f },
                                                                    uil::Alignment::DEFAULT,
                                                                    appContext.languageManager.Text("helper_game"),
        ...
        gameSettingsBtn->SetOnClick([]() {
            app::AppContext::GetInstance().eventManager.InvokeEvent(
                    eve::SwitchSceneEvent(uil::SceneType::GAME_SETTINGS));
        });
        settingsBtn->Add(gameSettingsBtn, true);

        incFID();

        auto appSettingsBtn = std::make_shared<uil::ClassicButton>(focusID,
                                                                   Vector2{ 0.0f, 0.0f },
                                                                   Vector2{ 0.0f, 0.0f },
                                                                   uil::Alignment::DEFAULT,
        ...
        auto quitBtn = std::make_shared<uil::ClassicButton>(focusID,
                                                            GetElementPosition(btnPosX, btnPosY),
                                                            GetElementSize(btnSizX, btnSizY),
                                                            uil::Alignment::MID_RIGHT,
