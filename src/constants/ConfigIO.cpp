...
*/
    ...
    void LoadConfig() {
        ...
        if (utl::usize out; loadUSize(events, out, ConfigTypes::MIN_BLACK_HOLE_RANGE    )) { constants.gameEvents.minBlackHoleRange                           = out ; }
        if (bool       out; loadBool (events, out, ConfigTypes::IS_MAX_BLACK_HOLE_RANGE )) { constants.gameEvents.isMaxBlackHoleRange                         = out ; }
        if (utl::usize out; loadUSize(events, out, ConfigTypes::MAX_BLACK_HOLE_RANGE    )) { constants.gameEvents.maxBlackHoleRange                           = out ; }
  ...
  // clang-format off
                ...
                { CToS(ConfigTypes::MIN_BLACK_HOLE_RANGE    ), constants.gameEvents.minBlackHoleRange                          },
                { CToS(ConfigTypes::IS_MAX_BLACK_HOLE_RANGE ), constants.gameEvents.isMaxBlackHoleRange                        },
                { CToS(ConfigTypes::MAX_BLACK_HOLE_RANGE    ), constants.gameEvents.maxBlackHoleRange                          },
