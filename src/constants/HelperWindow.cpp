...
namespace cst {
    bool HelperWindow::IsPossibleResolution(Resolution const toProve) const {
        ...
        if (window.nativeResolutionVec.y < value.y) {
            return false;
        }
        return true;
    }

    std::vector<std::pair<Resolution, std::string>> HelperWindow::GetAllResolutionsAsString() const {
    ...
    std::string HelperWindow::GetStringFromResolution(Resolution const resolution) const {

        switch (resolution) {

                // 16:9
            case Resolution::UHD2: return "UHD2 16:9 (7600 x 4320)";
            case Resolution::_5K: return "5K 16:9 (5120 x 2160)";
            case Resolution::UHD1: return "UHD1 16:9 (3840 x 2162)";
            case Resolution::WQHD: return "WQHD 16:9 (2560 x 1440)";
            case Resolution::FULL_HD: return "Full HD 16:9 (1920 x 1080)";
            case Resolution::HD:
                return "HD 16:9 (1280 x 720)";

                // 21:9
            case Resolution::_5K_ULTRA_WIDE: return "5K Ultrawide 21:9 (5120 x 2160)";
            case Resolution::UWQHD: return "UWQHD 21:9 (3440 x 1440)";
            case Resolution::UWHD:
                return "UWHD 21:9 (2560 X 1080)";

                // 4:3
            case Resolution::QXGA: return "QXGA 4:3 (2048 x 1536)";
            case Resolution::UXGA: return "UXGA 4:3 (1600 x 1200)";
            case Resolution::SXGA_Plus: return "SXGA Plus 4:3 (1400 x 1050)";
            case Resolution::XGA_plus: return "XGA Plus 4:3 (1152 x 864)";
            case Resolution::XGA: return "XGA 4:3 (1024 x 768)";
            case Resolution::SVGA: return "SVGA 4:3 (800 x 600)";
            case Resolution::PAL: return "PAL 4:3 (768 x 576)";
            ...
            default:
                hlp::Print(
                        hlp::PrintType::ERROR, "invalid resolution selected {}", static_cast<utl::usize>(resolution));
                return "invalid resolution";
        }
    }

    utl::vec2pos_ty HelperWindow::GetIntFromResolution(Resolution const resolution) const {
