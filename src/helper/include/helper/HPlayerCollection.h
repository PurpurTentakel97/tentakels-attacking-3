...
private:
  ...
  ///< contains the player data for the npcs
        { 100, "", WHITE, "helper_player_collection_npc_neutral_player" }
    };
    PlayerData m_defaultPlayer{
        0,
        "",
        WHITE,
        "helper_player_collection_npc_no_player"
    }; ///< contains default player witch is return if no other player is found.
