...
class Field:
    def __init__(self, prefix: str, name: str, type_: enums.CppType, value: str) -> None:
    ...
    def dump_getter(self, indent: int) -> str:
        text: str = f"{helper.indent(indent)}{enums.return_type_lookup[self.type_]} get_{self.name}() const {helper.left_bracket}\n"
